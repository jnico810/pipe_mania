	...
	var Space = function () {
	  ...
	  _createClass(Space, [{
	    ...
	    value: function handleClick(e) {
	      ...
	      var option = document.getElementById('side-tiles').lastChild;
	      var type = parseInt(option.getAttribute('type'));
	
	      this.drawPipe(type);
	      option.parentElement.removeChild(option);
	      //
	      var newOption = new Space([0, 0], option.getAttribute('id'), null, "option");
	      this.addNewOption(newOption);
	    }
	  }, {
	    key: "addNewOption",
	    value: function addNewOption(newOption) {
