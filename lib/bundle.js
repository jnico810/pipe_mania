	  ...
	  _createClass(Game, [{
	    ...
	    value: function generateSpaces() {
	      for (var i = 0; i < 7; i++) {
	        ...
	        for (var j = 0; j < 10; j++) {
	          if (i === 3 && j === 0) {
	            space = new _space2.default([0, 0], [i, j], spaces, "start", this.handleClick.bind(this));
	          } else {
	            space = new _space2.default([0, 0], [i, j], spaces, "tile", this.handleClick.bind(this));
	          }
	          space.createCanvas();
	    ...
	    value: function checkNextSpace() {
	      var y = parseInt(this.currentSludgeSpace.pos.y);
	      var x = parseInt(this.currentSludgeSpace.pos.x);
...
/***/ function(module, exports) {
	...
	var Space = function () {
	  function Space(coord, rowCol, parent, klass, handleClick) {
