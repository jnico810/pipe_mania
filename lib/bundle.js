	  ...
	  _createClass(Game, [{
	    ...
	    value: function generateSpaces() {
	      for (var i = 0; i < 7; i++) {
	        ...
	        for (var j = 0; j < 10; j++) {
	          if (i === 3 && j === 0) {
	            space = new _space2.default([0, 0], [i, j], spaces, "start", this.handleClick.bind(this), null);
	          } else {
	            space = new _space2.default([0, 0], [i, j], spaces, "tile", this.handleClick.bind(this), null);
	          }
	          space.createCanvas();
	    ...
	    value: function handleClick(space, e) {
	      ...
	      var newOption = new _space2.default([0, 0], [row, col], null, "option");
	    ...
	    value: function generateSideTiles() {
	      for (var i = 1; i < 6; i++) {
	        ...
	        var option = new _space2.default([0, 0], i + 'choice', spaces, "option", null, null);
	        option.createCanvas();
	    ...
	    key: 'animateVertical',
	    value: function animateVertical(di) {}
	  }]);
...
/***/ function(module, exports) {
	...
	var Space = function () {
	  function Space(coord, rowCol, parent, klass, handleClick, game) {
